...
CREATE TABLE `TBLSubscribe` (
	`Subscribe_ID` INT(15) NOT NULL AUTO_INCREMENT,
	`Gmail` TEXT(30) NOT NULL,
...
ALTER TABLE `TBLSubscribe` ADD CONSTRAINT `TBLSubscribe_fk0` FOREIGN KEY (`Gmail`) REFERENCES `tblCustomer`(`customer_id`);
